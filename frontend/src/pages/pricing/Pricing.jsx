...
const PLANS = [
  {
    ...
    features: [
      ...
      { label: '1 groupe par collection', key: 'groupes', included: true },
      { label: "Jusqu'à 20 FlashCard", key: 'flashcards', included: true },
      { label: "Jusqu'à 5 routines par jour", key: 'routines', included: true },
      { label: "Jusqu'à 7 tâches (to-do list)", key: 'todo', included: true },
      { label: "Jusqu'à 10 notes de tâche", key: 'notes', included: true },
    ],
  ...
  },
  {
    ...
    features: [
      { label: "Jusqu'à 10 collections (FlashCard)", key: 'collections', included: true },
      { label: "Jusqu'à 120 groupes par collection", key: 'groupes', included: true },
      { label: "Jusqu'à 200 FlashCard", key: 'flashcards', included: true },
      { label: 'Génération de collections par l\'IA', key: 'ai', included: true },
      { label: "Jusqu'à 20 routines par jour", key: 'routines', included: true },
      { label: "Jusqu'à 50 tâches (to-do list)", key: 'todo', included: true },
      { label: "Jusqu'à 50 notes de tâche", key: 'notes', included: true },
    ],
  ...
  },
  {
    ...
    monthly: 9.99,
    yearly: 79.99,
    description: 'Pour les apprenants exigeants qui révisent tous les jours.',
    features: [
      { label: "Jusqu'à 100 collections (FlashCard)", key: 'collections', included: true },
      { label: "Jusqu'à 400 groupes par collection", key: 'groupes', included: true },
      ...
      { label: "Jusqu'à 1000 notes de tâche", key: 'notes', included: true },
    ],
    ctaLabel: 'Essai gratuit 7 jours',
    ctaVariant: 'soft',
  },
